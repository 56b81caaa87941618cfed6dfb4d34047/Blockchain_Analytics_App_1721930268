...
Vue.component("purple_feature_grid_component_1721930269", {
    template: `
    <!-- Features list -->
    <div id="features-grid" class="grid md:grid-cols-3 gap-8 md:gap-12 bg-white p-5">
        ...
        <div id="feature-1">
            ...
            <div class="flex" id="feature-1-description-container"><p id="feature-1-description" class="flex-1 text-sm" :class="textPrimaryStyle">Our app provides advanced analytics to instantly analyze new blockchain data as it becomes available, giving you a comprehensive understanding of emerging trends and patterns.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-2">
            ...
            <div class="flex" id="feature-2-description-container"><p id="feature-2-description" class="flex-1 text-sm" :class="textPrimaryStyle">Keep track of all smart contract activity across multiple blockchains with our intelligent monitoring system, ensuring you never miss critical events or updates.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-3">
            ...
            <div class="flex" id="feature-3-description-container"><p id="feature-3-description" class="flex-1 text-sm" :class="textPrimaryStyle">Create visually stunning dashboards tailored to your specific needs, displaying key metrics, charts, and insights from the blockchain data that matters most to you.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-4">
            <div id="feature-4-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-4-title-container"><h4 id="feature-4-title" class="flex-1 font-medium" :class="textSecondaryStyle">Automated Alerts</h4></div>
            </div>
            <div class="flex" id="feature-4-description-container"><p id="feature-4-description" class="flex-1 text-sm" :class="textPrimaryStyle">Set up custom alerts to be notified instantly when predefined conditions or events occur on the blockchain, allowing you to react swiftly to emerging opportunities or potential threats.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-5">
            ...
            <div class="flex" id="feature-5-description-container"><p id="feature-5-description" class="flex-1 text-sm" :class="textPrimaryStyle">Our platform seamlessly integrates data from multiple blockchains, providing a unified view of the entire decentralized ecosystem and enabling comprehensive analysis across different networks.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-6">
            ...
            <div class="flex" id="feature-6-description-container"><p id="feature-6-description" class="flex-1 text-sm" :class="textPrimaryStyle">Built with robust security measures and a fault-tolerant architecture, our app ensures the utmost data integrity and uninterrupted service, giving you peace of mind when analyzing sensitive blockchain information.</p></div>
        </div>
    </div>`,
        data() {
            return {
